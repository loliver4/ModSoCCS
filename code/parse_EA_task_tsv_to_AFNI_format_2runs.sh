...
sublist="/projects/loliver/ModSoCCS/data/processed/EA_task_1D_sublist_meeting.txt"
index () {
...
python3 /projects/loliver/ModSoCCS/code/parse_EA_task_tsv_to_AFNI_format_2runs.py ${sub_indir}/`index` ${subj} ${sub_outdir}/${bids}/ses-${ses}
