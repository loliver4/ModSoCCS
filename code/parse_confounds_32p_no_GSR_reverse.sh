...
sublist="/projects/loliver/ModSoCCS/data/processed/3dDeconvolve_sublist_meeting_reverse.txt"
...
for dir in ${ses_dirs}; do
    ...
    if [ ! -f ${sub_outdir}/${sub_id}/${ses}/${sub_id}_ea_confounds_no_GSR_glm.1D ]; then
      python3 /projects/loliver/ModSoCCS/code/parse_confounds_32p_no_GSR_reverse.py ${sub_indir}/${sub_id}/${ses}/func "`index`" ${sub_outdir}/${sub_id}/${ses}
    fi
